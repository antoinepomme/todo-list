...
.submit-button:hover {
    ...
    color: white;
}`, "",{"version":3,"sources":["webpack://./src/styles/forms.css"],"names":[],"mappings":"AAAA;IACI,aAAa;IACb,4DAA4D;IAC5D,SAAS;AACb;;AAEA;IACI,oBAAoB;IACpB,iBAAiB;IACjB,YAAY;AAChB;;AAEA;IACI,YAAY;IACZ,aAAa;AACjB;;AAEA;IACI,YAAY;IACZ,oBAAoB;IACpB,eAAe;IACf,YAAY;AAChB;;AAEA;IACI,YAAY;IACZ,aAAa;AACjB;;AAEA;IACI,aAAa;IACb,oEAAoE;IACpE,SAAS;AACb;;AAEA;IACI,oBAAoB;IACpB,sBAAsB;IACtB,yBAAyB;IACzB,kBAAkB;IAClB,cAAc;IACd,gBAAgB;AACpB;;AAEA;IACI,aAAa;AACjB;;AAEA;IACI,eAAe;IACf,kBAAkB;AACtB;;AAEA;IACI,eAAe;IACf,kBAAkB;IAClB,aAAa;IACb,WAAW;AACf;;AAEA;IACI,WAAW;AACf;;AAEA;IACI,kBAAkB;IAClB,UAAU;IACV,YAAY;IACZ,WAAW;IACX,UAAU;IACV,eAAe;AACnB;;;AAGA;IACI,iBAAiB;IACjB,gBAAgB;IAChB,sBAAsB;IACtB,eAAe;AACnB;;AAEA;IACI,uBAAuB;IACvB,kBAAkB;IAClB,YAAY;AAChB;;AAEA;IACI,wBAAwB;IACxB,kBAAkB;IAClB,aAAa;AACjB;;AAEA;IACI,qBAAqB;IACrB,kBAAkB;IAClB,UAAU;AACd;;AAEA;;;IAGI,uBAAuB;IACvB,YAAY;AAChB;;AAEA;;;IAGI,wBAAwB;IACxB,YAAY;AAChB;;AAEA;;;IAGI,qBAAqB;IACrB,YAAY;AAChB;;AAEA;IACI,sBAAsB;IACtB,eAAe;IACf,kBAAkB;IAClB,iBAAiB;IACjB,kBAAkB;IAClB,yBAAyB;IACzB,kBAAkB;IAClB,cAAc;IACd,gBAAgB;IAChB,eAAe;AACnB;;AAEA;IACI,yBAAyB;IACzB,YAAY;AAChB","sourcesContent":[".todo-form {\n    display: grid;\n    grid-template: max-content 1fr max-content max-content / 1fr;\n    gap: 1rem;\n}\n\n.todo-form-title {\n    font-family: inherit;\n    font-size: 1.5rem;\n    border: none;\n}\n\n.todo-form-title:focus {\n    border: none;\n    outline: none;\n}\n\n.todo-form-description {\n    resize: none;\n    font-family: inherit;\n    font-size: 1rem;\n    border: none;\n}\n\n.todo-form-description:focus {\n    border: none;\n    outline: none;\n}\n\n.form-date-container {\n    display: grid;\n    grid-template: max-content max-content / max-content max-content 1fr;\n    gap: 1rem;\n}\n\n.todo-form-date {\n    font-family: inherit;\n    padding: 0.3rem 0.5rem;\n    border: solid #3ba395 1px;\n    border-radius: 5px;\n    color: #3ba395;\n    font-weight: 600;\n}\n\n.todo-form-date:focus {\n    outline: none;\n}\n\n.todo-form-date + label {\n    grid-row: 2 / 3;\n    grid-column: 1 / 2;\n}\n\n.radio-container {\n    grid-row: 2 / 3;\n    grid-column: 2 / 3;\n    display: flex;\n    gap: 0.8rem;\n}\n\n.todo-form-priority {\n    width: 3rem;\n}\n\n.radio > input[type=\"radio\"] {\n    position: relative;\n    opacity: 0;\n    left: 1.5rem;\n    height: 1px;\n    width: 1px;\n    cursor: pointer;\n}\n\n\n.radio > label {\n    font-size: 0.8rem;\n    font-weight: 600;\n    padding: 0.3rem 0.5rem;\n    cursor: pointer;\n}\n\n.low {\n    border: solid green 1px;\n    border-radius: 5px;\n    color: green;\n}\n\n.medium {\n    border: solid orange 1px;\n    border-radius: 5px;\n    color: orange;\n}\n\n.high {\n    border: solid red 1px;\n    border-radius: 5px;\n    color: red;\n}\n\n.low:hover,\n.radio > input:checked + .low,\n.radio > input[type=\"radio\"]:hover + .low {\n    background-color: green;\n    color: white;\n}\n\n.medium:hover,\n.radio > input:checked + .medium,\n.radio > input[type=\"radio\"]:hover + .medium {\n    background-color: orange;\n    color: white;\n}\n\n.high:hover,\n.radio > input:checked + .high,\n.radio > input[type=\"radio\"]:hover + .high {\n    background-color: red;\n    color: white;\n}\n\n.submit-button {    \n    padding: 0.3rem 0.5rem;\n    grid-row: 2 / 3;\n    grid-column: 3 / 4;\n    justify-self: end;\n    width: fit-content;\n    border: solid #3ba395 1px;\n    border-radius: 5px;\n    color: #3ba395;\n    font-weight: 600;\n    cursor: pointer;\n}\n\n.submit-button:hover {\n    background-color: #3ba395;\n    color: white;\n}"],"sourceRoot":""}]);
// Exports
